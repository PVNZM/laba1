...
std::string makeDecision(int x, int y); // Объявление функции для сравнения двух чисел
...
std::string listNums(int x);            // Объявление функции для создания строки чисел
std::string chet(int x);                // Объявление функции для получения четных чисел
